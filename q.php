        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              <h2 id="title_quest"><?php echo $quest[$q]['title']; ?></h2>
                ...
                <td class="text-left">
                  <?php foreach ($times as $k=>$time) {
                    ...
                    if ($q==1){
                      ...
                      if ($value['date']== '20140616' && ($time == '10:15' || $time == '14:00' || $time == '22:45')) $dis = 1;
                    }
                    if ($q==2){
                      ...
                      if ($value['date']== '20140616' && ($time == '11:30' || $time == '15:15')) $dis = 1;                     
                    } 
          ...
          <div class="modal-body">
            <form role="form">
              <div class="form-group">
                <label for="name">Имя</label><input class="form-control input-lg" id="name" type="text">
              </div>
              <div class="form-group">
                <label for="phone">Телефон</label><input class="form-control input-lg" id="phone" type="text">
              </div>
              <div class="form-group">
                <label for="mail">Email</label><input class="form-control input-lg" id="mail" type="text">
              </div>
